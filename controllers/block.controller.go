...
func (c *BlockController) BeforeActivation(b mvc.BeforeActivation) {
...
func (c *BlockController) GetList(sideId string) MvcResult {
...
func (c *BlockController) GetById(id string) MvcResult {
	if id == "" {
		return c.Result
	}
...
func (c *BlockController) PostAdd() MvcResult {
	_block := &models.Block{}
...
func (c *BlockController) PostUpdate(id string) MvcResult {
...
func (c *BlockController) PostDelete(id string) MvcResult {
